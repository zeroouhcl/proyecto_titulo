...
<html>
    ...
    <body data-spy="scroll" data-target="#navbarNav" data-offset="50">
        ...
        <br>
        <br>
            <div class="containersus">
                <h2>Escoga su plan de suscripcion</h2>
                <div class="price-row">
                    <div class="price-col">
                        <p>MENSUAL</p>
                        <h3>$5.000 <span>CLP</span></h3>
                        <ul>
                            <li>Puedes ingresar hasta 10 fotos</li>
                            <li>Puedes registrar horas</li>
                            <li>Tus visitas pueden tomar tus horas</li>
                        </ul>
                        <button>Suscribirse</button>
                    </div>
                    <div class="price-col">
                        <p>3 MESES</p>
                        <h3>$12.000 <span>CLP</span></h3>
                        <ul>
                            <li>Puedes ingresar hasta 10 fotos</li>
                            <li>Puedes registrar horas</li>
                            <li>Tus visitas pueden tomar tus horas</li>
