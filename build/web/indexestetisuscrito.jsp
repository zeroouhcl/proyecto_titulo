            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link smoothScroll"> Mi Suscripcion</a>
                        </li>
                        <li class="nav-item ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu text-center"><br>
                                <a>${Esteticista.correoUsuario}</a>
                                <a>Cargo: <span>${Esteticista.rol.RolUsuario}</span>
                                <div class="dropdown-divider"></div>
                                <a href="srvCliente?accion=cerrar" class="dropdown-item">Cerrar Sesión</a>
                            </div>
                        </li>
                    </ul>
                </div>
