<%-- 
    Document   : esteticista
    Created on : 29 may. 2022, 2:36:19
    Author     : zeroouh
--%>
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    ...
                                    <div class="card-footer text-">
                                        ...
                                        <br>
                                        <div>
                                            <a class="btn btn-primary" style="background-color: #3b5998;" href="#!" role="button"><i class="fab fa-facebook me-2"></i>Facebook</a>
                                        </div>
                                        <br>
                                        <div>
                                            <a class="btn btn-primary" style="background-color: #ac2bac;" href="#!" role="button"><i class="fab fa-instagram me-2"></i>Instragram</a>
                                        </div>
                                        <br>
                                        <div style="text-align: center;">
